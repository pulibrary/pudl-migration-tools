...
# component image from Western Americana WC055.  The input to this
# script is a json-formatted file containing the mappings of EAD
# component ids, METS OBJID, and path to the TIFF image.

# example:
# ruby wc055-ingest.rb -r assets.json -d /mnt/diglibdata > wc055.sh

require 'optparse'
require 'json'

# default collection to id on staging for now
options = {
  collection: 'e201720c-e1bb-48eb-854d-5bc0aa6f57c6',
...
OptionParser.new do |parser|
  parser.banner = 'Usage: wc055-ingest.rb -r assets.json -d /mnt/diglibdata -c mycollectionid -f .tif > wc055.sh'
